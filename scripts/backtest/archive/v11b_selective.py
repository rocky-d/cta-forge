"""CTA-Forge v11 — Expanded universe (42 symbols) max-range backtest."""
...
SYMBOLS = [
    # Tier 1 — OG, listed 2019-2020, deep liquidity
    "BTCUSDT", "ETHUSDT", "SOLUSDT", "XRPUSDT", "DOGEUSDT",
    "BNBUSDT", "ADAUSDT", "AVAXUSDT", "NEARUSDT", "LINKUSDT",
    "FILUSDT", "DOTUSDT", "BCHUSDT", "AAVEUSDT", "LTCUSDT",
    "UNIUSDT", "CRVUSDT", "TRXUSDT", "XLMUSDT", "ETCUSDT",
    "ZECUSDT", "DASHUSDT", "ENJUSDT", "ONTUSDT", "ZENUSDT",
    "XMRUSDT",
    # Tier 2 — established 2021-2023
    "1000SHIBUSDT", "APTUSDT", "ARBUSDT", "OPUSDT", "SUIUSDT",
    "1000PEPEUSDT", "FETUSDT", "1000BONKUSDT", "WLDUSDT",
    "DUSKUSDT", "GALAUSDT", "HBARUSDT", "CTSIUSDT", "LPTUSDT",
    "IDUSDT", "TRUUSDT",
]
TIMEFRAME = "6h"
...
async def main():
    ...
    print("=" * 60, flush=True)
    print(
        "CTA-Forge v11 — Selective Universe Max-Range Backtest",
        flush=True,
    )
    print("=" * 60, flush=True)
    ...
    axes[0].set_title(
        f"CTA-Forge v11 — Max-Range Backtest "
    ...
    fig.autofmt_xdate()
    fig.savefig(
        OUT_DIR / "backtest_v11b_selective.png",
        dpi=150,
        bbox_inches="tight",
        facecolor="white",
    )
    ...
    # Save metrics
    (OUT_DIR / "metrics_v11b_selective.json").write_text(
        json.dumps(
            {
    ...
    print(
        f"Charts: {OUT_DIR / 'backtest_v11b_selective.png'}",
        flush=True,
    )
