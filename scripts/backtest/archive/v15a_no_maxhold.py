"""CTA-Forge v15a — v10g without max hold limit."""
...
async def main():
    ...
    fig.autofmt_xdate()
    fig.savefig(
        OUT_DIR / "backtest_v15a_no_maxhold.png",
        dpi=150,
        bbox_inches="tight",
        facecolor="white",
    )
    ...
    # Save metrics
    (OUT_DIR / "metrics_v15a_no_maxhold.json").write_text(
        json.dumps(
            {
    ...
    print(
        f"Charts: {OUT_DIR / 'backtest_v15a_no_maxhold.png'}",
        flush=True,
    )
