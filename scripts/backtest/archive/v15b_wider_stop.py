"""CTA-Forge v15b — v10g with relaxed stop tightening."""
...
async def main():
    ...
    fig.autofmt_xdate()
    fig.savefig(
        OUT_DIR / "backtest_v15b_wider_stop.png",
        dpi=150,
        bbox_inches="tight",
        facecolor="white",
    )
    ...
    # Save metrics
    (OUT_DIR / "metrics_v15b_wider_stop.json").write_text(
        json.dumps(
            {
    ...
    print(
        f"Charts: {OUT_DIR / 'backtest_v15b_wider_stop.png'}",
        flush=True,
    )
