...
async def get_config() -> dict[str, Any]:
    ...
    return {
        ...
        "live_instance_id": os.environ.get("LIVE_INSTANCE_ID", ""),
        "public_instance_slug": os.environ.get("PUBLIC_INSTANCE_SLUG", ""),
        ...
        "mainnet_pilot_caps": {
            "max_equity": float(
                os.environ.get(MAINNET_MAX_EQUITY_ENV, "200")
            ),
            ...
            "target_gross_cap": float(
                os.environ.get(MAINNET_MAX_GROSS_CAP_ENV, "4.0")
            ),
            "leverage": float(
                os.environ.get(MAINNET_MAX_LEVERAGE_ENV, "5")
            ),
        },
    }
