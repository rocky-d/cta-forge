...
These are pure functions: no I/O, no strategy knowledge, no exchange calls.
Callers (scripts or executor) handle data preparation and result consumption.
"""
...
from .result import ExecutionBacktestResult, TargetBacktestResult
